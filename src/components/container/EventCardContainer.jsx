            ...
            <Row gutter={[16, 16]} justify="center">
                <Col span={15}>
                    ...
                    <Row gutter={[15, 15]} justify="center">
                        ...
                        <Col xs={24} sm={24} md={8} lg={8} xl={8}><EventCard heading={"AIM Summit"} content={`We discussed "Hedge Funds - What investors currently are looking for from their hedge fund allocation".`} cardLink="https://www.aimsummit.com/" date={"28 September 2022"} backgroundImage="https://static.wixstatic.com/media/834e5b_139b1772d0d94504a7735a98713914e8~mv2.gif" />
                        </Col>
                        <Col xs={24} sm={24} md={8} lg={8} xl={8}><EventCard heading={"FTT Embedded Finance"} content={`Our Head of Capital Markets, Patrizia Lando, spoke about Buy Now Pay Later at the FTT Embedded Finance conference in London.`} cardLink="https://www.fintechtalents.com/" date={"28 September 2022"} backgroundImage="https://static.wixstatic.com/media/834e5b_061583accbf14c10b58c062d96e7c63c~mv2.gif" /></Col>
                    </Row>
                </Col>
            </Row>
        </div>
